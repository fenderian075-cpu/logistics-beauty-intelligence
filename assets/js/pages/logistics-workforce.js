...
export async function init() {
  ...
  /* ---- age structure: composition, not six lines ---- */
  ...
  /* ---- driver treatment: the gap is the point ---- */
  /* Compare only within one common year. The three average-age series share a
     source and end in the same year today, but taking each series' own latest
     observation would silently compare different years the moment one of them
     is updated first. */
  ...
  /* Wage and hours come from the same retrospective series as the all-industry
     benchmark, so they can be compared within a year — that comparison is the
     recruiting reality, and it is what the dumbbell shows. */
  ...
  /* ---- foreign workforce: employment ≠ policy capacity ---- */
